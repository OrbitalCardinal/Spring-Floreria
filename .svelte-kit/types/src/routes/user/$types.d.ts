...
type LayoutRouteId = RouteId | "/user" | "/user/cart" | "/user/info" | "/user/login" | "/user/orders" | "/user/signin"
...
type ActionsExport = typeof import('../../../../../src/routes/user/+page.server.js').actions
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/user/+layout.server.js').load>>>>>>;
